...
[Search: "expected goals soccer" on Google Scholar]
- Foundational work on xG
- Industry adoption
- Known limitations

### 3.2 Tactical Analysis
[Search: "positional play soccer analytics", "passing networks"]
- Possession-based metrics
- Positional play research
- **Gap:** No work on xG-parity subset

### 3.3 Clustering in Sports
[Search: "clustering sports analytics"]
- Basketball, baseball, hockey applications
- Common algorithms (K-means, hierarchical, DBSCAN)
- Transfer to soccer

### 3.4 Existing Tools
- FBref, Understat, StatsBomb IQ capabilities
- **Gap:** No archetype identification or xG-parity focus
